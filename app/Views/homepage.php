                        ...
                        <?php if (isset($kapus)) { ?>
                            <div class="template-doctor">
                                <div class="template-doctor-image-wrapper">
                                    <!-- <img src="data:image/<?php #$kapus[0]["extension"]; ?>charset=utf8;base64,<?php #base64_encode($kapus[0]["image"]); ?>" alt="<?php #asset_url(); ?>img/default/template_image.png"></img> -->
                                </div>
                                <!-- <b class="template-doctor-nama"><?php #$kapus[0]["nama"]; ?></b> -->
                            </div>
                        <?php } else { ?>
                            <div class="template-doctor">
                                <div class="template-doctor-image-wrapper">
                ...
                <ul class="doctor-list">
                    <li>
                        <?php if (isset($katu)) { ?>
                            <div class="template-doctor">
                                <div class="template-doctor-image-wrapper">
                                    <!-- <img src="data:image/<?php #$katu[0]["extension"]; ?>;charset=utf8;base64,<?php #base64_encode($katu[0]["image"]); ?>" alt="<?php #asset_url(); ?>img/default/template_image.png"></img> -->
                                </div>
                                <!-- <b class="template-doctor-nama"><?php #$katu[0]["nama"]; ?></b> -->
                            </div>
                        <?php } else { ?>
                            <div class="template-doctor">
                                <div class="template-doctor-image-wrapper">
